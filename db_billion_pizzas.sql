...
CREATE TABLE IF NOT EXISTS bebidas(
    ...
    CONSTRAINT fk_bebidas FOREIGN KEY (proveedor_id) REFERENCES proveedores(id)
);
...
CREATE TABLE IF NOT EXISTS menu(
    ...
    PRIMARY KEY(id_menu),
    CONSTRAINT fk_comidas_id FOREIGN KEY (comidas_id) REFERENCES comidas(id_comidas),
    CONSTRAINT fk_bebidas_id FOREIGN KEY (bebidas_id) REFERENCES bebidas(id_bebidas)
);
