<%-- 
    Document   : clientes
    Created on : 25/08/2022, 14:04:21
    Author     : informatica
--%>
                                ...
                                <tbody>
                                    <c:forEach var="cliente" items="${listadoDeClientes}">
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletClientes?accion=eliminar&idCliente=${cliente.id_clientes}">
                                                    <i class="fa-solid fa-user-xmark"></i>Elimnar
                                                </a>
